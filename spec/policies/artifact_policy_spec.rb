describe ArtifactPolicy do
  subject { ArtifactPolicy }
  ...
  permissions :show? do
    ...
    it "allows anyone to see any artifact" do
      expect(subject).to permit(admin)
    end
  end
  ...
  permissions :destroy? do
    it "allows an admin to delete any artifact" do
      expect(subject).to permit(admin)
    end
    it "allows an archivist to delete any artifact" do
      expect(subject).to permit(admin)
    end
    ...
    permissions :create? do
      ...
      it "allows an archivist to create" do
        expect(subject).to permit(archivist)
      end
    ...
    permissions :new? do
      it "allows an admin to go to new path" do
        expect(subject).to permit(admin)
      end
      it "allows an archivist to go to new path" do
        expect(subject).to permit(archivist)
      end
